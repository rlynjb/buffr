...
Use available raw and reported evidence from Product Context / Observation.

When processing a completed experiment, also use:

- the experiment's raw result data,
- the baseline previously selected and validated for that test,
- any validated qualification rules already established.
