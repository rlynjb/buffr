...
- the hypothesis, experimental variable, revision, control variables, and conceptual expected signal from **M5 — Hypothesis & Experiment Design**,
- the validated baseline, comparison-validity decision, and applicable qualification rules from **M2 — Metrics & Qualification**,
- findings from **M3 — Domain Research** when a measurement rule required research.

Treat the M2 baseline and comparison-validity decision as upstream inputs.

## Dependencies

- **M0 — Core Agent:** required shared reasoning and guardrails.
- **M5 — Hypothesis & Experiment Design:** required experiment-design input.
- **M2 — Metrics & Qualification:** required baseline, comparison validity, and available qualification rules.
- **M3 — Domain Research:** conditional/callable when a measurement requirement is unresolved.
