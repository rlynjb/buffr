...
- the hypothesis and controlled experiment design from **M5 — Hypothesis & Experiment Design**,
- the frozen measurement plan and context-to-monitor from **M6 — Test Definition**,
- post-experiment calculated metrics, baseline comparison, comparison validity, and metric qualification from **M2 — Metrics & Qualification**,
- the contextual conditions actually observed during the completed test,
- findings from **M3 — Domain Research** only when a research question had to be resolved before evaluation could continue.
...
- **M5 — Hypothesis & Experiment Design:** required hypothesis and intervention context.
- **M6 — Test Definition:** required frozen measurement plan.
- **M2 — Metrics & Qualification:** required qualified post-experiment evidence.
- **M3 — Domain Research:** conditional/callable when an unresolved domain or methodological question blocks evaluation.
