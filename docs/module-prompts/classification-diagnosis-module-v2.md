...
- product context and evidence provenance from Product Context / Observation,
- calculated metrics, baseline comparison, comparison validity, and metric qualification from Metrics & Qualification,
- Domain Research findings when research was required.

Treat upstream metric and baseline outputs as authoritative inputs for this diagnostic pass.
