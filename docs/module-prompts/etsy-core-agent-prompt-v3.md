...
No module-specific analytical input is required.

The Core Prompt is shared behavioral context applied whenever an operational module runs.

## Outputs

Shared system guidance for:
...
- **None.** M0 is the shared policy layer consumed by M1–M7.
