...
Receive a focused research request containing:

- the specific unresolved research question,
- why the answer matters to the calling module,
- the type of evidence needed,
- enough product or analytical context to judge relevance.

The request may come from M2, M4, M5, M6, or M7.

## Dependencies

- **M0 — Core Agent:** required shared reasoning and guardrails.
- **Calling module:** required for the research question and relevant context.
- **External research tools / sources:** required when the question cannot be resolved from supplied evidence.

M3 has no fixed sequential upstream module; it is a callable research service.
